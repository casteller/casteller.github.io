 ...
 * Last Update: 2020/4/26 涓嬪崍8:39:08
 * Modify by HCLonely
 */
! function(e, t) {
...
*/
        ...
        function(e, t, n) {
            ...
            o.prototype.Q = function(e) {
                    ...
                    v[t] = n, n.on("input change blur propertychange", function(r) {
                        e.config.enableQQ && "blur" === r.type && "nick" === t && (isNaN(n.val()) ? y.
                            ...
                            default.store.get(h.QQCacheKey).nick != n.val() && (y.
                                default.store.remove(h.QQCacheKey), E.nick = n.val(), E.mail = "", E.QQAvatar = "") : (0, _.fetchQQFn)(n.val(), function(e) {
                                var t = e.nick || n.val(),
                                    r = e.qq + "@qq.com";
                                (0, y.
                ...
                ! function(t) {
                    if (t = y.
                        default.store.get(h.MetaCacheKey) || t)
                        for (var n in p) {
                            var r = p[n];
                            e.$el.find(".v" + r).val(y.
                ...
                var z = e.$el.find(".vsubmit"),
                    L = function(t) {
                        if (e.config.requiredFields.indexOf("nick") > -1 && E.nick.length < 0) return v.nick[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
                        if ("" == j) return void v.comment[0].focus();
                        E.comment = j, E.nick = E.nick || "涓€浣嶄笉鎰挎剰閫忛湶濮撳悕鐨勬湅鍙�";
                        var n = y.
                        default.store.get("vlx");
                        if (n) {
                            if (Date.now() / 1e3 - n / 1e3 < 1) return void e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3)
                        }
                        U()
                    }, F = function() {
                        var e = new AV.ACL;
        ...
        function(e, t, n) {
            ...
            d.code = function(e, t) {
                return '<pre><code class="hljs language-' + t + '">' + (!t || !hljs.getLanguage(t) ? s.
                    default.escape(e) : hljs.highlight(t, e).value) + "</code></pre>"
            }, i.
            default.setOptions({
...
*/
            ...
            if (!Object.keys) {
                ...
                r = function(e) {
                    ...
                    if (r && e.length > 0)
                        ...
                        for (var g in e) p && "prototype" === g || !o.call(e, g) || d.push(String(g)); if (l)
        ...
        function(e, t) {
            e.exports = {
                ...
                mail: "銉°兗銉偄銉夈儸銈�",
                link: "銈点偆銉�(http://)",
                nickFail: "3銉愩偆銉堜互涓娿伄銉嬨儍銈儘銉笺儬銈掋仈鍏ュ姏銇忋仩銇曘亜.",
                mailFail: "銉°兗銉偄銉夈儸銈广倰銇旂⒑瑾嶃亸銇犮仌銇�.",
                sofa: "銈炽儭銉炽儓銇椼伨銇椼倗銇唦",
                submit: "鎻愬嚭銇欍倠",
                reply: "杩斾俊銇欍倠",
                cancelReply: "銈儯銉炽偦銉�",
                ...
                uploadDone: "銈儍銉椼儹銉笺儔銇屽畬浜嗐仐銇俱仐銇�!",
                busy: "20 绉掗枔闅斻仹鎻愬嚭銇椼仸銇忋仩銇曘亜    ...",
                "code-98": "銉兗銉夈偍銉┿兗銇с仚銆俛v-min.js 銇儛銉笺偢銉с兂銈掔⒑瑾嶃仐銇︺亸銇犮仌銇�.",
                "code-99": "銉兗銉夈偍銉┿兗銇с仚銆俰nit銇亗銈媊el`銈ㄣ儸銉°兂銉堛倰纰鸿獚銇忋仩銇曘亜.",
                "code-100": "銉兗銉夈偍銉┿兗銇с仚銆侫ppId銇ˋppKey銈掔⒑瑾嶃亸銇犮仌銇�.",
                "code-140": "浠婃棩銇瓵PI銈炽兗銉伄绶忔暟銇岄枊鐧恒儛銉笺偢銉с兂銇笂闄愩倰瓒呫亪銇�.",
                "code-401": "妯╅檺銇屽埗闄愩仌銈屻仸銇勩伨銇欍€侫ppId銇ˋppKey銈掔⒑瑾嶃亸銇犮仌銇�.",
                "code-403": "銈偗銈汇偣銇孉PI銇仼銇埗闄愩仌銈屻伨銇椼仧銆併儔銉°偆銉冲悕銇偦銈儱銉儐銈ｈō瀹氥倰纰鸿獚銇忋仩銇曘亜"
            }
        },
        function(e, t) {
            e.exports = {
                ...
                mail: "閭",
                link: "缃戝潃(http://)",
                nickFail: "鏄电О涓嶈兘灏戜簬3涓瓧绗�",
                mailFail: "璇峰～鍐欐纭殑閭欢鍦板潃",
                sofa: "鏉ュ彂璇勮鍚",
                submit: "鎻愪氦",
                reply: "鍥炲",
                cancelReply: "鍙栨秷鍥炲",
                ...
                uploading: "姝ｅ湪浼犺緭...",
                uploadDone: "浼犺緭瀹屾垚!",
                busy: "鎿嶄綔棰戠箒锛岃绋嶅€欏啀璇�...",
                "code-98": "Valine 鍒濆鍖栧け璐ワ紝璇锋鏌� av-min.js 鐗堟湰",
                "code-99": "Valine 鍒濆鍖栧け璐ワ紝璇锋鏌nit涓殑`el`鍏冪礌.",
                "code-100": "Valine 鍒濆鍖栧け璐ワ紝璇锋鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                "code-140": "浠婃棩 API 璋冪敤鎬绘鏁板凡瓒呰繃寮€鍙戠増闄愬埗.",
                "code-401": "鏈粡鎺堟潈鐨勬搷浣滐紝璇锋鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                "code-403": "璁块棶琚獳PI鍩熷悕鐧藉悕鍗曟嫆缁濓紝璇锋鏌ヤ綘鐨勫畨鍏ㄥ煙鍚嶈缃�."
            }
        },
        function(e, t) {
            e.exports = {
                ...
                mail: "閮电",
                link: "缍插潃(http://)",
                nickFail: "鏄电ū涓嶈兘灏戞柤3鍊嬪瓧绗�",
                mailFail: "璜嬪～瀵纰虹殑閮典欢鍦板潃",
                sofa: "渚嗙櫦瑭曡珫鍚",
                submit: "鎻愪氦",
                reply: "鍥炶",
                cancelReply: "鍙栨秷鍥炶",
                ...
                uploading: "姝ｅ湪涓婂偝...",
                uploadDone: "涓婂偝瀹屾垚!",
                busy: "鎿嶄綔闋荤箒锛岃珛绋嶅€欏啀瑭�...",
                "code-98": "Valine 鍒濆鍖栧け鏁楋紝璜嬫鏌� av-min.js 鐗堟湰",
                "code-99": "Valine 鍒濆鍖栧け鏁楋紝璜嬫鏌nit涓殑`el`鍏冪礌.",
                "code-100": "Valine 鍒濆鍖栧け鏁楋紝璜嬫鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                "code-140": "浠婃棩 API 瑾跨敤绺芥鏁稿凡瓒呴亷闁嬬櫦鐗堥檺鍒�.",
                "code-401": "鏈稉鎺堟瑠鐨勬搷浣滐紝璜嬫鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                "code-403": "瑷晱琚獳PI鍩熷悕鐧藉悕鍠嫆绲曪紝璜嬫鏌ヤ綘鐨勫畨鍏ㄥ煙鍚嶈ō缃�."
            }
        },
        function(e, t, n) {
            var r = n(59);
